        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Row(mainAxisAlignment: MainAxisAlignment.center,
              children: [
                Text("Foire Aux Questions",style: TextStyle(fontFamily: 'normal',fontSize: 16),),
              ],
            ),
            Image.asset("assets/images/faq.png"),
            h(15),
            Text("Q1. Comment fonctionne Guidi Immo ?",style: TextStyle(fontFamily: 'normal',fontSize: 15),),
            h(10),
            ...
            h(15),
            Text("Q2. Comment puis-je télécharger Guidi Immo ?",style: TextStyle(fontFamily: 'normal',fontSize: 15),),
            h(10),
            ...
            h(15),
            Text("Q3. Comment puis-je effectuer une recherche sur l'application ?",style: TextStyle(fontFamily: 'normal',fontSize: 15),),
            h(10),
            ...
            h(15),
            Text("Q4. Puis-je contacter directement les propriétaires des logements ?",style: TextStyle(fontFamily: 'normal',fontSize: 15),),
            h(10),
            ...
            h(15),
            Text("Q5. Comment puis-je signaler une annonce frauduleuse ou inappropriée ?",style: TextStyle(fontFamily: 'normal',fontSize: 15),),
            h(10),
            ...
            h(15),
            Text("Q6. Que signifie Mo GEUNEU ?",style: TextStyle(fontFamily: 'normal',fontSize: 15),),
            h(10),
