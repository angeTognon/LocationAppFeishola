            ...
            children: [
              ...
              InkWell(
                ...
                child: Row(mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    Icon(isClicked1? Icons.circle : Icons.circle_outlined,color: isClicked1? Colors.orange : Colors.black,),w(20),
                    Text("Je cherche un logement",style: TextStyle(fontFamily: 'normal2'),)
                  ],
                ),
              ),
              h(15),
              InkWell(
                ...
                child: Row(mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    Icon(isClicked2? Icons.circle : Icons.circle_outlined,color: isClicked2? Colors.orange : Colors.black,),w(20),

                    Text("Je veux publier des logements\nsur l'application",style: TextStyle(fontFamily: 'normal2'),)
                  ],
                ),
              ),
              h(10),
